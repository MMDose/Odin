...
function FaqPage() {
  const faqs = [
    { id: 1, title: "HOW MUCH VOLUME ODIN CAN GENERATE?", text: "We offer most high volume generation. 3 SOL 180K Volume Volume depends on your Deposit as well. 10 SOL Deposit 3 SOL Spent can make you higher Volume then 3 SOL Deposit." },
    ...
    { id: 3, title: "ODIN Supports other chains?", text: "We are developing bots on SUI and BASE, TRON. Soon big announcements are going to be dropped." },
    ...
    { id: 5, title: "HOW TO EARN WITH ODIN?", text: (<> REFERRAL BONUS. We are offering dynamic  referral  bonus  for  our users.<br /><br />1 User 10% fees from your referral<br /> 3 Users 20% fees from your referral<br /> 6 Users 40% fees from your referral<br /> 10 Users 50% fees from your referral </>) },
  ];
